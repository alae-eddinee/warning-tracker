...
export function StoreCard({ store, enseigneName, compact = false }: StoreCardProps) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 min-w-0 flex-1">
              ...
              <div className="min-w-0 flex-1">
                ...
                {!compact && enseigneName && (
                  <p className="text-xs text-gray-500 truncate">{enseigneName}</p>
                )}
              </div>
            </div>
